...
public final class GameFont extends DrawingArea {
     ...
     * @param archive   The archive containing the information about
     *                  the font.
     ...
     *
     * @param input          The array of pixel states (1 if drawn,
     *                       0 if not drawn.)
     * @param inputPosition  The position in the input array to start at.
     * @param inputWidth     The amount to increase the position in the
     ...
     * @param outputWidth    The amount to increase the position in the
